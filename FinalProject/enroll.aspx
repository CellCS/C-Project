...
<head runat="server">
    ...
    *
    ...
    body
    {
        background-image:url(http://localhost:2277/FinalProject/images/login_bg1.jpg);
    ...
    #blackTri {
        background-image:url(http://localhost:2277/FinalProject/images/blackTriangle.png);
        width: 18px;
        height: 10px;
...
<body>
    ...
    <div id="blackTri"></div>
        ...
        <div id="right" style="width:300px;background-color: #ffffff;float:right;margin:0px 20px 20px 0;border:1px solid #DCDEE0;border-radius: 4px;padding:10px;">
            ...
            <br />
            <div style="margin:0 auto;width:60%;"><asp:Button ID="upload1" runat="server" Text="上传头像" style="width:100%;padding:6px 12px;font-size:12px;"/></div>
